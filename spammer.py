...
def update():
    ...
    if update.lower() == "y":
        ...
        try:
            file.write(get("https://raw.githubusercontent.com/Flazers/spammer/master/spammer.py").content)
            file.close()
            system("spammer")
        except UnboundLocalError:
            system("cd $HOME && rm -rf spammer && git clone https://github.com/Flazers/spammer/ && cd spammer && sh install.sh")
    else:
        main()
